  ...
  return (
    <button className="course-card" onClick={onClick}>
      <div className={`course-art ${tone}`}>
        {!thumbnailFailed && <img src={thumbnailUrl} alt="" onError={() => setThumbnailFailed(true)} style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'contain', background: '#f2f4f7' }} />}
