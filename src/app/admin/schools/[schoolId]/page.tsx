  ...
  return <AdminShell active="schools">
    <div className="page-wrap">
      ...
      <section className="panel" style={{ marginBottom: 24 }}>
        <div className="panel-head"><div><p className="eyebrow">School team</p><h2>Teachers and headteacher</h2></div><div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}><button className="secondary-button" onClick={() => router.push(`/school/teachers/import?schoolId=${schoolId}`)}><FileUp size={16} /> Bulk upload CSV</button><button className="primary-button" onClick={() => setShowInvite(!showInvite)}><Plus size={16} /> Add teacher</button></div></div>
