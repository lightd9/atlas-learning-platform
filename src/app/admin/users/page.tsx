...
import { Users, Search, Plus, Mail, Power, ShieldCheck, Trash2, UserPlus, KeyRound } from 'lucide-react'
...
export default function AdminUsersPage() {
  ...
  async function resetPassword(user: AdminUser, password?: string) {
    ...
    if (!window.confirm(`Set the password for ${user.name} (${user.email}) to the password you entered? They will use this password on their next login.`)) return
    setResetBusy(true)
  ...
  return <AdminShell active="users">
    <div className="page-wrap">
      ...
      {resetTarget && <SetPasswordModal
        ...
        description="Choose the new password this user will sign in with."
